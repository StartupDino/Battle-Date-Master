...
var allBattles: [BattleDate] = [
    ...
    BattleDate(description: "Battle of Hyrba", year: <#T##Int#>),
    BattleDate(description: "Battle of Pingyu", year: <#T##Int#>),
    BattleDate(description: "Battle of Lake Regillus", year: <#T##Int#>),
    BattleDate(description: "Battle of Salamis", year: <#T##Int#>),
    BattleDate(description: "Sack of Carthage", year: <#T##Int#>),
    BattleDate(description: "Conquest of Mecca", year: <#T##Int#>),
    BattleDate(description: "Battle Qadisiya", year: <#T##Int#>),
    BattleDate(description: "Battle of Yarmouk", year: <#T##Int#>),
    BattleDate(description: "Sack of Constantinople", year: <#T##Int#>),
    BattleDate(description: "Battle of 13 Sides", year: <#T##Int#>),
    BattleDate(description: "Battle of Maritsa", year: <#T##Int#>),
    BattleDate(description: "Siege of Nanjing", year: <#T##Int#>),
    BattleDate(description: "Battle of the Kondurcha River", year: <#T##Int#>),
    BattleDate(description: "Battle of Technochticlan", year: <#T##Int#>),
    BattleDate(description: "Battle of Diu", year: <#T##Int#>),
    BattleDate(description: "Siege of Vienna", year: <#T##Int#>),
    BattleDate(description: "Battle of Breitenfeld", year: <#T##Int#>),
    BattleDate(description: "Battle of Rocroi", year: <#T##Int#>),
    BattleDate(description: "Battle of Mollwitz", year: <#T##Int#>),
    BattleDate(description: "Siege of Toulon", year: <#T##Int#>),
    BattleDate(description: "Battle of Trafalgar", year: <#T##Int#>),
    BattleDate(description: "Battle of Borodino", year: <#T##Int#>),
    BattleDate(description: "The Spring Offensive", year: <#T##Int#>),
    BattleDate(description: "The Long March", year: <#T##Int#>),
